    ...
    async function fetchData() {
      try {
        ...
        try {
          ...
          // No bills this month yet — that's fine
        }
      } catch (err: unknown) {
        setError(
    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-500 mt-1">
          GST Bill Digitization & Classification — Overview
        </p>
      </div>
      ...
      {health && (
        <div className="mb-6 flex items-center gap-4 text-sm">
          ...
          <span className="text-gray-400">
            Business: <span className="text-gray-300">{health.business_type}</span>
          </span>
        </div>
      )}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <KPICard
          ...
          value={
            summary
              ? `₹${summary.itc_eligible_amount.toLocaleString("en-IN")}`
              : "₹0"
          }
      ...
      <div className="rounded-xl border border-gray-800 bg-gray-900/50">
        ...
        {bills.length === 0 ? (
          <div className="p-12 text-center">
            ...
            <Link
              href="/upload"
              className="inline-block mt-3 px-4 py-2 rounded-lg bg-indigo-500 hover:bg-indigo-600 text-white text-sm font-medium transition-colors"
            >
